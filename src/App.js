...
function App() {
  ...
  const [skylineId, setSkyline] = useState('skyline-1');
  const [waterfrontId, setWaterfront] = useState('waterfront-1');
  const [castleId, setCastle] = useState('castle-1');
  ...
  return (
    <div className="App">
      ...
      <div className="bottom">
        ...
        <SloganForm setSlogans={setSlogans} slogans={slogan} />
